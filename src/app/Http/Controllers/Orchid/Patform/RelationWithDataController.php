...
namespace App\Http\Controllers\Orchid\Patform;
...
use App\Http\Requests\RelationWithDataRequest;

class RelationWithDataController extends Controller
{
    /**
     * @param RelationWithDataRequest $request
     *
     * @return JsonResponse
     */
    public function view(RelationWithDataRequest $request)
    {
        [
            'model' => $model,
            'key'   => $key,
