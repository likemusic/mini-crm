...
/***/ "./resources/js/controllers/relation_with_data_controller.js":
/*!*******************************************************************!*\
  !*** ./resources/js/controllers/relation_with_data_controller.js ***!
  \*******************************************************************/
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      var dataFieldNames = this.data.get('data_field_names');
      $.ajaxSetup({
        headers: {
          ...
          processResults: function processResults(data) {
            ...
            var ret = {
              results: Object.keys(data).reduce(function (res, id) {
                ...
                return [].concat(_toConsumableArray(res), [_objectSpread({
                  id: id,
                  text: data[id][name]
                }, data[id])]);
              }, [])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _controllers_relation_with_data_controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controllers/relation_with_data_controller */ "./resources/js/controllers/relation_with_data_controller.js");
...
/***/ "./resources/sass/orchid/app.scss":
/*!****************************************!*\
  !*** ./resources/sass/orchid/app.scss ***!
  \****************************************/
/*! no static exports found */
...
/***/ 0:
/*!****************************************************************************************************!*\
  !*** multi ./resources/js/dashboard.js ./resources/sass/app.scss ./resources/sass/orchid/app.scss ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /usr/share/nginx/html/resources/js/dashboard.js */"./resources/js/dashboard.js");
__webpack_require__(/*! /usr/share/nginx/html/resources/sass/app.scss */"./resources/sass/app.scss");
module.exports = __webpack_require__(/*! /usr/share/nginx/html/resources/sass/orchid/app.scss */"./resources/sass/orchid/app.scss");


/***/ })

},[[0,"/resources/orchid/js/manifest","/resources/orchid/js/vendor"]]]);
